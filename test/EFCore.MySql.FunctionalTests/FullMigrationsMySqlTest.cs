...
ALTER TABLE `FooBar` ADD CONSTRAINT `FK_FooBar_Bar_BarId` FOREIGN KEY (`BarId`) REFERENCES `Bar` (`BarId`) ON DELETE RESTRICT;

ALTER TABLE `FooBar` ADD CONSTRAINT `FK_FooBar_Foo_FooId` FOREIGN KEY (`FooId`) REFERENCES `Foo` (`FooId`) ON DELETE RESTRICT;
