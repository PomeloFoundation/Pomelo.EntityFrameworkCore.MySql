...
--- |--------------------------------------------------------------------------------------------------|--------------------|:----------:|:-----------:| :---: | :---:
[8.0.0-<br />beta.1](https://www.nuget.org/packages/Pomelo.EntityFrameworkCore.MySql/7.0.0) | [master](https://github.com/PomeloFoundation/Pomelo.EntityFrameworkCore.MySql/tree/master)       | >= 2.3.0-beta.3           | 8.0.0-<br />rc.1 |    8.0+     | - | -
