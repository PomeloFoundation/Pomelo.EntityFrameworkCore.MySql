...
namespace Microsoft.EntityFrameworkCore
{
    public class MySqlValueGeneratorSelectorTest
    {
        ...
        public void Returns_built_in_generators_for_types_setup_for_value_generation()
        {
            ...
            Assert.IsType<MySqlSequenceHiLoValueGenerator<int>>(selector.Select(entityType.FindProperty("AlwaysSequence"), entityType));
        }
        ...
        public void Returns_temp_guid_generator_when_default_sql_set()
        {
            ...
            entityType.FindProperty("Guid").MySql().DefaultValueSql = "newid()";
        ...
        public void Returns_temp_string_generator_when_default_sql_set()
        {
            ...
            entityType.FindProperty("String").MySql().DefaultValueSql = "Foo";
        ...
        public void Returns_temp_binary_generator_when_default_sql_set()
        {
            ...
            entityType.FindProperty("Binary").MySql().DefaultValueSql = "Foo";
        ...
        public void Returns_sequence_value_generators_when_configured_for_model()
        {
            ...
            model.MySql().GetOrAddSequence(MySqlModelAnnotations.DefaultHiLoSequenceName);
            var entityType = model.FindEntityType(typeof(AnEntity));
            ...
            Assert.IsType<CustomValueGenerator>(selector.Select(entityType.FindProperty("Custom"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<long>>(selector.Select(entityType.FindProperty("Long"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<short>>(selector.Select(entityType.FindProperty("Short"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<byte>>(selector.Select(entityType.FindProperty("Byte"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<int>>(selector.Select(entityType.FindProperty("NullableInt"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<long>>(selector.Select(entityType.FindProperty("NullableLong"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<short>>(selector.Select(entityType.FindProperty("NullableShort"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<byte>>(selector.Select(entityType.FindProperty("NullableByte"), entityType));
            Assert.IsType<MySqlSequenceHiLoValueGenerator<decimal>>(selector.Select(entityType.FindProperty("Decimal"), entityType));
            Assert.IsType<StringValueGenerator>(selector.Select(entityType.FindProperty("String"), entityType));
            Assert.IsType<SequentialGuidValueGenerator>(selector.Select(entityType.FindProperty("Guid"), entityType));
            Assert.IsType<BinaryValueGenerator>(selector.Select(entityType.FindProperty("Binary"), entityType));
            Assert.IsType<TemporaryIntValueGenerator>(selector.Select(entityType.FindProperty("AlwaysIdentity"), entityType));
        ...
        {
            var model = MySqlTestHelpers.Instance.BuildModelFor<AnEntity>();
            model.MySql().ValueGenerationStrategy = MySqlValueGenerationStrategy.SequenceHiLo;
            model.MySql().GetOrAddSequence(MySqlModelAnnotations.DefaultHiLoSequenceName);
            var entityType = model.FindEntityType(typeof(AnEntity));
        ...
        private static IMutableModel BuildModel(bool generateValues = true)
        {
            ...
            entityType.FindProperty("AlwaysIdentity").MySql().ValueGenerationStrategy = MySqlValueGenerationStrategy.IdentityColumn;

            entityType.FindProperty("AlwaysSequence").ValueGenerated = ValueGenerated.OnAdd;
            entityType.FindProperty("AlwaysSequence").MySql().ValueGenerationStrategy = MySqlValueGenerationStrategy.SequenceHiLo;
