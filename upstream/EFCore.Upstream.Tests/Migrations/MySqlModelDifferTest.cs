        ...
        public void Alter_primary_key_clustering()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    Assert.True((bool)addOperation[MySqlAnnotationNames.Clustered]);
                });
        }
        ...
        public void Add_non_clustered_primary_key_with_owned()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    Assert.False((bool)addKey[MySqlAnnotationNames.Clustered]);
                });
        }
        ...
        public void Alter_index_clustering()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    Assert.True((bool)createOperation[MySqlAnnotationNames.Clustered]);
                });
        }
        ...
        public void Rebuild_index_with_different_include()
        {
            Execute(
                ...
                operations =>
                {
                    ...
                    var annotation = operation2.GetAnnotation(MySqlAnnotationNames.Include);
