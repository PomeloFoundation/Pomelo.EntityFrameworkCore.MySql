...
#pragma warning restore 618
        ...
        [InlineData("MySqlValueGenerationStrategy", "DefaultValue")]
        [InlineData("MySqlValueGenerationStrategy", "DefaultValueSql")]
        [InlineData("MySqlValueGenerationStrategy", "ComputedColumnSql")]
        ...
        protected virtual void ConfigureProperty(IMutableProperty property, string configuration, string value)
        {
            switch (configuration)
            {
                ...
                case "ComputedColumnSql":
                    ...
                    break;
                case "MySqlValueGenerationStrategy":
...
#pragma warning restore 618
        ...
        public void Passes_for_online_index(bool obsolete)
        {
            ...
            {
#pragma warning disable 618
                modelBuilder.Entity<Dog>().HasIndex(nameof(Dog.Name)).ForMySqlIsCreatedOnline();
#pragma warning restore 618
            }
            else
            {
