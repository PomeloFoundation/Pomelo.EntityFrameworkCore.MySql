    ...
    public class MySqlInternalMetadataBuilderExtensionsTest
    {
        ...
        public void Can_access_model()
        {
            ...
            Assert.NotNull(builder
                .HasValueGenerationStrategy(MySqlValueGenerationStrategy.SequenceHiLo));
            Assert.Equal(MySqlValueGenerationStrategy.SequenceHiLo, builder.Metadata.GetValueGenerationStrategy());

            Assert.NotNull(builder
                    .HasValueGenerationStrategy(MySqlValueGenerationStrategy.IdentityColumn, fromDataAnnotation: true));
            Assert.Equal(
                MySqlValueGenerationStrategy.IdentityColumn, builder.Metadata.GetValueGenerationStrategy());

            Assert.Null(builder
                .HasValueGenerationStrategy(MySqlValueGenerationStrategy.SequenceHiLo));
            Assert.Equal(MySqlValueGenerationStrategy.IdentityColumn, builder.Metadata.GetValueGenerationStrategy());
...
#pragma warning disable 618
                Assert.NotNull(indexBuilder.ForMySqlIsClustered(true));
#pragma warning restore 618
            ...
            {
#pragma warning disable 618
                Assert.NotNull(indexBuilder.ForMySqlIsClustered(false, fromDataAnnotation: true));
#pragma warning restore 618
            }
            else
            {
            ...
            {
#pragma warning disable 618
                Assert.Null(indexBuilder.ForMySqlIsClustered(true));
#pragma warning restore 618
            }
            else
            {
