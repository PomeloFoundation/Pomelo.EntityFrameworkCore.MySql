...
{
    public class MySqlTypeMapperTest : RelationalTypeMapperTestBase
    {
        [Fact]
        ...
        [InlineData("float", typeof(double), null, false)] // This is correct. MySql 'float' type maps to C# double
        ...
        [InlineData("timestamp", typeof(byte[]), 8, false)] // note: rowversion is a synonym but MySql stores the data type as 'timestamp'
        ...
        protected override ModelBuilder CreateModelBuilder() => MySqlTestHelpers.Instance.CreateConventionBuilder();
