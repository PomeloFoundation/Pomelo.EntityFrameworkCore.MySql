                ...
                using (var reader = command.ExecuteReader())
                {
                    while (reader.Read())
                    {
                        ...
                        if (supportsMemoryOptimizedTable)
                        {
                            ...
                            {
                                table[MySqlAnnotationNames.MemoryOptimized] = true;
                            }
                        }
                ...
                using (var reader = command.ExecuteReader())
                {
                    ...
                    foreach (var tableIndexGroup in tableIndexGroups)
                    {
                        ...
                        if (primaryKeyGroups.Length == 1)
                        {
                            ...
                            {
                                primaryKey[MySqlAnnotationNames.Clustered] = false;
                            }
                        ...
                        foreach (var uniqueConstraintGroup in uniqueConstraintGroups)
                        {
                            ...
                            {
                                uniqueConstraint[MySqlAnnotationNames.Clustered] = true;
                            }
                        ...
                        foreach (var indexGroup in indexGroups)
                        {
                            ...
                            {
                                index[MySqlAnnotationNames.Clustered] = true;
                            }
