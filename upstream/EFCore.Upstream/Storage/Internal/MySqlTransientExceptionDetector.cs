            ...
            if (ex is SqlException sqlException)
            {
                foreach (SqlError err in sqlException.Errors)
                {
                    switch (err.Number)
                    {
                        ...
                        // A network-related or instance-specific error occurred while establishing a connection to MySql.
                        // The server was not found or was not accessible. Verify that the instance name is correct and that MySql
                        ...
                        // Possible causes include the following: the client tried to connect to an unsupported version of MySql;
