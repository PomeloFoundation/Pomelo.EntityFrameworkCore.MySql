...
namespace Pomelo.EntityFrameworkCore.MySql.Storage.Internal
{
    ...
    /// </summary>
    public class MySqlUdtTypeMapping : RelationalTypeMapping
    {
        ...
        protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
            => new MySqlUdtTypeMapping(parameters, LiteralGenerator, UdtTypeName);
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static MySqlUdtTypeMapping CreateSqlHierarchyIdMapping(Type udtType)
            => new MySqlUdtTypeMapping(
                udtType,
                "hierarchyid",
                v => Expression.Call(
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public static MySqlUdtTypeMapping CreateSqlSpatialMapping(Type udtType, string storeName)
            => new MySqlUdtTypeMapping(
                udtType,
                storeName,
                v =>
