...
namespace Microsoft.EntityFrameworkCore.Infrastructure
{
    /// <summary>
    ///     <para>
    ///         Allows MySql specific configuration to be performed on <see cref="DbContextOptions" />.
    ///     </para>
    ///     <para>
        ...
        : RelationalDbContextOptionsBuilder<MySqlDbContextOptionsBuilder, MySqlOptionsExtension>
    {
        ...
        /// <summary>
        ///     Use a ROW_NUMBER() in queries instead of OFFSET/FETCH. This method is backwards-compatible to MySql 2005.
        /// </summary>
