...
{
    public class MySqlEndToEndTest : IClassFixture<MySqlFixture>
    {
        private const string DatabaseName = "MySqlEndToEndTest";

        protected MySqlFixture Fixture { get; }

        public MySqlEndToEndTest(MySqlFixture fixture)
        {
            Fixture = fixture;
