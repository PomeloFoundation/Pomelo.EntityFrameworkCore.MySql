...
DROP TABLE [db2].[PrincipalTable];");
        ...
        [ConditionalFact]
        [MySqlCondition(MySqlCondition.SupportsMemoryOptimized)]
                ...
                dbModel =>
                    {
                        ...
                        // ReSharper disable once PossibleNullReferenceException
                        Assert.True((bool)table[MySqlAnnotationNames.MemoryOptimized]);
                    },
                "DROP TABLE [Blogs]");
        }
                ...
                dbModel =>
                    {
                        ...
                        Assert.Null(pk[MySqlAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.Null(uniqueConstraint[MySqlAnnotationNames.Clustered]);
...
CREATE TABLE NullableColumns (
    ...
    NonNullString nvarchar(max) NOT NULL,
        ...
        [ConditionalFact]
        [MySqlCondition(MySqlCondition.SupportsHiddenColumns)]
                ...
                dbModel =>
                    {
                        ...
                        Assert.False((bool)pk[MySqlAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.True((bool)uniqueConstraint[MySqlAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.True((bool)index[MySqlAnnotationNames.Clustered]);
