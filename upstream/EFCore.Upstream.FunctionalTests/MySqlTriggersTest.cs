...
{
    public class MySqlTriggersTest : IClassFixture<MySqlTriggersTest.MySqlTriggersFixture>
    {
        public MySqlTriggersTest(MySqlTriggersFixture fixture) => Fixture = fixture;
        ...
        public class MySqlTriggersFixture : SharedStoreFixtureBase<PoolableDbContext>
        {
            protected override string StoreName { get; } = "MySqlTriggers";
