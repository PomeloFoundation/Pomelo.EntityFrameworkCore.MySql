        ...
        public virtual void AddColumnOperation_identity()
        {
            Generate(
                new AddColumnOperation
                {
                    ...
                    DefaultValue = 0,
                    IsNullable = false,
                    [MySqlAnnotationNames.Identity] = "1, 1"
                });
        ...
        public virtual void AddColumnOperation_identity_seed_increment()
        {
            Generate(
                new AddColumnOperation
                {
                    ...
                    DefaultValue = 0,
                    IsNullable = false,
                    [MySqlAnnotationNames.Identity] = "100,5"
                });
                ...
                modelBuilder => modelBuilder
                    ...
                    .Entity(
                        "Person", x =>
                        {
                            ...
                            {
#pragma warning disable 618
                                x.HasIndex("FirstName", "LastName").ForMySqlInclude("Name");
#pragma warning restore 618
                            }
                            else
                            {
                ...
                modelBuilder => modelBuilder
                    ...
                    .Entity(
                        "Person", x =>
                        {
                            ...
                            {
#pragma warning disable 618
                                x.HasIndex("Name").ForMySqlIsCreatedOnline();
#pragma warning restore 618
                            }
                            else
                            {
                ...
                new CreateIndexOperation
                {
                    ...
                    Table = "Person",
                    Columns = new[] { "Name" },
                    [MySqlAnnotationNames.CreatedOnline] = true
                });
        ...
        public virtual void CreateIndexOperation_memoryOptimized_unique_nullable(bool obsolete)
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People", x =>
                {
                    ...
                    {
#pragma warning disable 618
                        x.ToTable("People", "dbo").ForMySqlIsMemoryOptimized().Property<string>("Name");
#pragma warning restore 618
                    }
                    else
                    {
        ...
        public virtual void CreateIndexOperation_memoryOptimized_unique_nullable_with_filter(bool obsolete)
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People", x =>
                {
                    ...
                    {
#pragma warning disable 618
                        x.ForMySqlIsMemoryOptimized().Property<string>("Name");
#pragma warning restore 618
                    }
                    else
                    {
        ...
        public virtual void CreateIndexOperation_memoryOptimized_unique_nonclustered_not_nullable(bool obsolete)
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People", x =>
                {
                    ...
                    {
#pragma warning disable 618
                        x.ForMySqlIsMemoryOptimized().Property<string>("Name").IsRequired();
#pragma warning restore 618
                    }
                    else
                    {
