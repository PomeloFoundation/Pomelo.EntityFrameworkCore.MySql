...
namespace Microsoft.EntityFrameworkCore
{
    public class MySqlMigrationSqlGeneratorTest : MigrationSqlGeneratorTestBase
    {
        ...
        public virtual void AddPrimaryKeyOperation_nonclustered()
        {
            Generate(
                new AddPrimaryKeyOperation
                {
                    Table = "People",
                    Columns = new[] { "Id" },
                    [MySqlAnnotationNames.Clustered] = false
                });
        ...
        public virtual void AlterColumnOperation_add_identity()
        {
            ...
            Assert.Equal(MySqlStrings.AlterIdentityColumn, ex.Message);
        }
        ...
        {
            Generate(new MySqlCreateDatabaseOperation { Name = "Northwind", FileName = "Narf.mdf" });
        ...
        public virtual void CreateDatabaseOperation_with_filename_and_datadirectory()
        {
            ...
            Generate(new MySqlCreateDatabaseOperation { Name = "Northwind", FileName = "|DataDirectory|Narf.mdf" });
        ...
        {
            Generate(new AlterDatabaseOperation { [MySqlAnnotationNames.MemoryOptimized] = true });
        ...
        public virtual void CreateIndexOperation_clustered()
        {
            Generate(
                new CreateIndexOperation
                {
                    ...
                    Table = "People",
                    Columns = new[] { "Name" },
                    [MySqlAnnotationNames.Clustered] = true
                });
        ...
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People").ToTable("People", "dbo").ForMySqlIsMemoryOptimized().Property<string>("Name"),
                new CreateIndexOperation
                {
                    Name = "IX_People_Name",
                    Schema = "dbo",
        ...
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People").ForMySqlIsMemoryOptimized().Property<string>("Name"),
                new CreateIndexOperation
                {
                    Name = "IX_People_Name",
                    Table = "People",
        ...
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People").ForMySqlIsMemoryOptimized().Property<string>("Name").IsRequired(),
                new CreateIndexOperation
                {
                    Name = "IX_People_Name",
                    Table = "People",
        ...
        {
            Generate(new MySqlDropDatabaseOperation { Name = "Northwind" });
        ...
        {
            Generate(
                modelBuilder => modelBuilder.Entity("People").ForMySqlIsMemoryOptimized(),
        ...
        public MySqlMigrationSqlGeneratorTest()
