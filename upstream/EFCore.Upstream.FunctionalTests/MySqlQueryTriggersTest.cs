...
{
    public class MySqlQueryTriggersTest : IClassFixture<MySqlQueryTriggersTest.MySqlTriggersFixture>
    {
        public MySqlQueryTriggersTest(MySqlTriggersFixture fixture) => Fixture = fixture;
        ...
        public class MySqlTriggersFixture : SharedStoreFixtureBase<DbContext>
        {
            protected override string StoreName { get; } = "MySqlQueryTriggers";
