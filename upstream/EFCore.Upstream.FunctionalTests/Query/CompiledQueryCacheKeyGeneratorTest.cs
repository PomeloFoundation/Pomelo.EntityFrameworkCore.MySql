...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class CompiledQueryCacheKeyGeneratorTest
    {
        ...
        {
            using (var testStore = MySqlTestStore.GetOrCreateInitialized(nameof(CompiledQueryCacheKeyGeneratorTest)))
            {
                object key1, key2;
                Expression query;
        ...
        protected virtual DbContextOptions CreateOptions(MySqlTestStore testStore, bool rowNumberPaging)
        {
            ...
            if (rowNumberPaging)
            {
                new MySqlDbContextOptionsBuilder(builder).UseRowNumberForPaging();
            }
