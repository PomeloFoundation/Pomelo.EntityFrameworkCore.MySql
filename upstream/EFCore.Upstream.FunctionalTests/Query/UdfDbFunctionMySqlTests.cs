...
{
    public class UdfDbFunctionMySqlTests : IClassFixture<UdfDbFunctionMySqlTests.MySqlUDFFixture>
    {
        public UdfDbFunctionMySqlTests(MySqlUDFFixture fixture, ITestOutputHelper testOutputHelper)
        {
            Fixture = fixture;
        ...
        private MySqlUDFFixture Fixture { get; }
...
WHERE 3 = [dbo].[CustomerOrderCount](ABS([c].[Id]))");
        ...
        public class MySqlUDFFixture : SharedStoreFixtureBase<DbContext>
        {
            protected override string StoreName { get; } = "UDFDbFunctionMySqlTests";
