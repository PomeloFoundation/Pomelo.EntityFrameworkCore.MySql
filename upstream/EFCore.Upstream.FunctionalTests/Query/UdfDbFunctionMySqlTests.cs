...
{
    public class UdfDbFunctionMySqlTests : UdfDbFunctionTestBase<UdfDbFunctionMySqlTests.MySql>
    {
        public UdfDbFunctionMySqlTests(MySql fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
WHERE 3 = [dbo].[CustomerOrderCount](ABS([c].[Id]))");
        ...
        public class MySql : UdfFixtureBase
        {
