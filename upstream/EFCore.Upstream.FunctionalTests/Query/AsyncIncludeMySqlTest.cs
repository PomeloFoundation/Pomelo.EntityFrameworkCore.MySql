...
{
    public class AsyncIncludeMySqlTest : IncludeAsyncTestBase<IncludeMySqlFixture>
    {
        public AsyncIncludeMySqlTest(IncludeMySqlFixture fixture, ITestOutputHelper testOutputHelper)
            : base(fixture)
        {
...
ORDER BY [t1].[CustomerID], [t1].[OrderID]");
        ...
        [MySqlCondition(MySqlCondition.SupportsOffset)] // Test does not pass on MySql 2008. TODO: See issue#7160
