        ...
        public void Inserts_are_batched_only_when_necessary(int minBatchSize)
        {
            ...
            TestHelpers.ExecuteWithStrategyInTransaction(
                ...
                context =>
                {
                    ...
                    Assert.Contains(
                        minBatchSize == 3
                            ? RelationalResources.LogBatchReadyForExecution(new TestLogger<MySqlLoggingDefinitions>()).GenerateMessage(3)
                            : RelationalResources.LogBatchSmallerThanMinBatchSize(new TestLogger<MySqlLoggingDefinitions>()).GenerateMessage(3, 4),
...
ALTER TABLE dbo.Owners
    ALTER COLUMN Name nvarchar(MAX);");
            ...
            public DbContext CreateContext(int minBatchSize)
            {
                ...
                new MySqlDbContextOptionsBuilder(optionsBuilder).MinBatchSize(minBatchSize);
